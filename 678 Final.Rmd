...
```
Using 0.7 as a limit, we can see that the conclusion that GPM,CSM,DPM are related is correct. Also,CSD.15,GD.15,XPD.15 are related. So I choose KDA, presence,DPM and GD.15 as the variables used in the model.
```{r, warning=F}
model <- lmer(Winrate ~ KDA+ Presence+DPM+GD.15+Avg.BT+(1|position),
              data = d12)
model
